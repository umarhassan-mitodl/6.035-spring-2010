...
This handout only mentions a small subset of the rich possibilities provided by the x86-64 instruction set and architecture. For a more complete (but still readable) introduction, consult The {{% resource_link "f290644a-a855-4caf-aafa-4ff5cb7b9ce8" "*AMD64 Architecture Programmer's Manual, Volume 1: Application Programming*" %}}.

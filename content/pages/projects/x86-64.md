...
This handout only mentions a small subset of the rich possibilities provided by the x86-64 instruction set and architecture. For a more complete (but still readable) introduction, consult The {{% resource_link "55dda54b-23f1-4e32-9f28-96147fb67956" "*AMD64 Architecture Programmer's Manual, Volume 1: Application Programming*" %}}.
